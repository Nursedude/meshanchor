...
| Feature | Tests | Notes |
|---------|-------|-------|
| Handler registry | 70 | <!--STAT:handlers-->86<!--/STAT--> handler files, Protocol + BaseHandler pattern |
...
for the live count) across <!--STAT:testfiles-->241<!--/STAT--> test files. However, automated tests
