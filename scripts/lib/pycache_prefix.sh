# scripts/lib/pycache_prefix.sh — PORTED from MeshForge b29e26ae (2026-09-20;
# on meshanchor-server the same day: 8 root-owned files in the repo).
# Keep the PRIVILEGED interpreter's bytecode
...
# root-owned `__pycache__` inside /opt/meshanchor. SEVEN of the ten fleet
...
MA_ROOT_PYCACHE="${MA_ROOT_PYCACHE:-/var/cache/meshanchor/pycache-root}"
