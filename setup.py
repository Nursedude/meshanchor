...
setup(
    ...
    author='Your Name',
    url='https://github.com/Nursedude/Meshtasticd_interactive_IU',
    license='GPL-3.0',
    ...
    project_urls={
        'Bug Reports': 'https://github.com/Nursedude/Meshtasticd_interactive_IU/issues',
        'Source': 'https://github.com/Nursedude/Meshtasticd_interactive_IU',
