...
Also walk the honest-failure-modes checklist over every error path in the diff
(MeshForge Issue #80 lesson — degraded state must never read as a valid value).
