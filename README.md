...
for the live count) across <!--STAT:testfiles-->208<!--/STAT--> test files. However, automated tests
...
tests/                     # <!--STAT:testfiles-->208<!--/STAT--> test files, ~5,900 tests
...
**~5,900 tests** across <!--STAT:testfiles-->208<!--/STAT--> test files. Top suites by depth
