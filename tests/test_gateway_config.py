...
class TestStaleHttpPortMigration:
    """Issue #62-pattern migration (parity port of MeshForge 6253d53):
    saved http_port=443 is the stale default that shipped in rendered
    fleet configs while meshtasticd's web API lives on 9443. load()
    must rewrite it; any other saved value is operator intent and must
    survive.
...
class TestMeshBridgeInjectionMode:
    ...
    Mirror of MeshForge TestMeshBridgeInjectionMode (e98612a)."""
