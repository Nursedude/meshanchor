"""TUI startup leanness gate (2026-07-13 perf arc, commit f4bbf65d, MF-port of 5aeebcc6).
...
imports dragged ~1,500 modules (~1.5 s on this class of box, worse on Pi 4) into every
