...
Ported from MeshForge (the RNS-reliability/honest-signal lead repo) 2026-07-14 —
MA carried the old unconditional-success shape; MF's version + test are the
reference (twin-first).
"""
