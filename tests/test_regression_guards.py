...
class TestSaveReturnChecked:
    ...
    .save() sweep — `settings.save()` (SettingsManager, also bool) and meshcore's
    `config.save()` — is tracked separately in the arc plan; many of those are
    benign silent-saves with no success dialog to belie."""
