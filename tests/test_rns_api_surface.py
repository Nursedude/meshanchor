...
MeshForge parity port, 2026-08-12 (MF leads this arc). There and HERE,
``_rns_bridge_connection._disconnect_rns`` called
...
as long as the line existed. This file was byte-identical across the two
repos, so MeshAnchor carried the identical bug and got the identical gate —
the untracked-diverged twin tier: port it, and test it here too.
