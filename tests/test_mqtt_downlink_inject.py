...
Mirror of MeshForge tests/test_mqtt_downlink_inject.py
(e98612a/a3d6960). Wire-format assertions are pinned against the exact shape
meshtasticd accepted in the step-0 field proof (moc, 2026-06-03):
...
# import errored the whole collection there (CI red since the downlink port).
...
# lands in a public repo and rotate it. (Mirror of MeshForge.)
