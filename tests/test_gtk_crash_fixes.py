"""
Tests for GTK crash fix patterns used in MeshForge.

These tests verify that the crash fix patterns work correctly:
...
Note: Tests that referenced deleted GTK4 source files (app.py, panel_base.py,
dashboard.py) have been removed since GTK4 UI is frozen/not actively developed.
Pure logic pattern tests are retained.

Run with: python3 -m pytest tests/test_gtk_crash_fixes.py -v
"""
