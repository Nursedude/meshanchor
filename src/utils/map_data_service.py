...
class MapServer:
    ...
    def start(self):
        ...
        # (e.g. large /api/map/geojson under fleet load) no longer blocks
        # subsequent requests. daemon_threads=True prevents hanging workers
...
def _apply_extra_trusted_networks(cors_origins, path=None):
    """Merge /etc/meshanchor/trusted_networks into the read gate's origins.
