...
def create_backup(
    ...
    try:
        ...
        # Save backup. backup_id is <device>_<second-resolution timestamp>,
        # so two backups of one device inside the same second collide; stepping
        # aside is right here because the second backup is still wanted, it just
        ...
        # ultra finding on the MF twin of this arc).
