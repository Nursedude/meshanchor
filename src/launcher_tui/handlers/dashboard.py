...
# level it pulls the RNS + meshtastic collector stack into TUI startup.
...
class DashboardHandler(BaseHandler):
    ...
    def _classify_http_unavailable(client) -> tuple:
        ...
        MF Issue #76: meshtasticd never serves ``/json/*`` (that API is ESP32
        ...
        Dormant on MA today (utils.meshtastic_http not shipped, test 3 takes
        the SKIP path) — ported from MF f07480d2 so the block is honest the
    ...
    def _show_alerts(self):
        ...
        try:
            ...
            # way this line can be true (honest_failure_modes #2). Ported from
            # MeshForge 2026-09-15.
