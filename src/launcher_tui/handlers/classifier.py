    ...
    def _classifier_menu(self):
        ...
        while True:
            ...
            choice = self.ctx.dialog.menu(
                ...
                "(the gateway's classifier is internal to meshanchor-gateway — "
                "see each screen):",
                choices
            )
...
def _print_not_visible_here() -> None:
    """The live classifier runs INSIDE meshanchor-gateway and exports neither its
    ...
    print("  meshanchor-gateway process and does not export its decisions, so")
