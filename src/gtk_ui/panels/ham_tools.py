...
class HamToolsPanel(CallsignLookupMixin, PropagationMixin, Gtk.Box):
    ...
    # Propagation methods (_on_refresh_bands, _on_fetch_pskreporter) provided by PropagationMixin
    # Callsign methods (_on_save_credentials, _on_lookup_callsign, _lookup_callook, _lookup_hamqth,
    #                   _hamqth_get_session, _lookup_qrz, _qrz_get_session, _display_callsign_result)
    # provided by CallsignLookupMixin
