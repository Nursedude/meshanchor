...
# Import mixins
from .hamclock_service_mixin import HamClockServiceMixin
from .hamclock_api_mixin import HamClockAPIMixin
from .hamclock_display_mixin import HamClockDisplayMixin
from .hamclock_features_mixin import HamClockFeaturesMixin


class HamClockPanel(
    HamClockServiceMixin,
    HamClockAPIMixin,
    HamClockDisplayMixin,
    HamClockFeaturesMixin,
    Gtk.Box
):
    ...
    # Service methods moved to HamClockServiceMixin
    ...
    # Fetch/parse methods moved to HamClockAPIMixin
    # Display update methods (_update_weather_display, etc.) moved to HamClockDisplayMixin
...
"""
    ...
    # _on_fetch_noaa moved to HamClockAPIMixin
    # NOAA display update methods moved to HamClockDisplayMixin
    # VOACAP display update methods moved to HamClockDisplayMixin
    # DX propagation button handler moved to HamClockFeaturesMixin
    ...
    # Feature methods (location, DX spots, satellite) moved to HamClockFeaturesMixin
    # Display update methods moved to HamClockDisplayMixin
