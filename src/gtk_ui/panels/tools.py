...
# Import mixins
from .tools_mixins import (
    SystemMonitorMixin, NetworkToolsMixin, NetworkDiagnosticsMixin,
    RFToolsMixin, HFPropagationMixin, SDRToolsMixin
)
...
class ToolsPanel(SystemMonitorMixin, NetworkToolsMixin, NetworkDiagnosticsMixin,
                 RFToolsMixin, HFPropagationMixin, SDRToolsMixin, Gtk.Box):
