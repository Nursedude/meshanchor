...
# RadioType, RadioConfig, and RADIO_TEMPLATES live in meshtasticd_templates.py
# Re-exported here for backward compatibility.
from core.meshtasticd_templates import RadioType, RadioConfig, RADIO_TEMPLATES  # noqa: F401
