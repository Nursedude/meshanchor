...
def _sanitize_positive(value, default):
    ...
    Inlined for MeshAnchor (no reply_context module — Thread-2 is MeshForge-
    lead). Test configs are MagicMocks and gateway.json is operator-edited —
    both must degrade to safe defaults rather than poison TTL math.
    """
