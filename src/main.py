...
# Extracted modules (main.py split for maintainability)
from main_rns import rns_tools_menu, gateway_bridge_menu
from main_device import (
    device_wizard, configure_device, configure_spi_hat,
    configure_radio_complete, configure_lora, configure_channels,
    configure_modules, configure_device_settings
)
from main_utils import (
    debug_menu, check_dependencies, detect_hardware,
    check_emoji_support, show_environment_config, view_logs,
    view_error_logs, test_service, check_permissions,
    check_updates_manual, show_version_history, show_version_info
)
